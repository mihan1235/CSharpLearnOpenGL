...
namespace HelloTriangleExercise1
{
    using glfw3;
...
//    Try to draw 2 triangles next to each other using glDrawArrays by adding more vertices to your
//    data
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            gl.VertexAttribPointer(0, 3, GL_FLOAT, false, 3 * sizeof(float), IntPtr.Zero);
